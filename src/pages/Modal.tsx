      ...
      <div className="modal  modal-bottom sm:modal-middle">
        <div className="modal-box bg-[#fff] ">
          ...
          <form action="" onSubmit={handleEdit}>
            ...
            <label htmlFor="title" className="mt-4 text-black">
              Title
            </label>
            <input
              name="Title"
            ...
            />
            <label htmlFor="author" className="mt-4 text-black">
              Author
            </label>
            <input
              name="Author"
            ...
            />
            <label htmlFor="genre" className="mt-4 text-black">
              Genre
            </label>
            <input
              name="Genre"
            ...
            />
            <label htmlFor="date" className="mt-4 text-black">
              Publication Date
            </label>{" "}
            <br />
            <DatePicker
            ...
            <input
              type="submit"
              value="submit"
              className="w-full mt-4 bg-[#000] py-2 rounded text-[#fff] font-bold"
            />
          </form>
        </div>
      </div>
